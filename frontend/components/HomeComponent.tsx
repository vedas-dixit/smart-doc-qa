...
const HomeComponent = () => {
    ...
    return (
        <div className="relative flex h-screen flex-col bg-gray-50">
            {/* Chat header */}
            <div className="sticky top-0 z-10 bg-blue-500 px-4 py-3 text-white shadow-md">
                <h1 className="text-center text-lg font-medium">AI Assistant</h1>
            </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {isLoading && (
                            <div className="flex justify-start">
                                <div className="bg-white max-w-[80%] rounded-xl px-4 py-3 shadow">
